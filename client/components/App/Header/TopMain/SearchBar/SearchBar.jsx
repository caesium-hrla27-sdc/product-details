...
class SearchBar extends React.Component {
  ...
  render() {
    return (<div id={styles.container1}>
      <div>
      <div >
      ...
      <input id={styles.searchInput} autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck="false" maxLength="70" type="text" placeholder="Search"/>
      </div>
      </div>
