...
class TopBarOptions extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return (
      <div id={styles.container1}>
        <a id={styles.a}>
          <svg viewBox="0 0 24 24" id={styles.reorderSvg}>
            <path d="M15.1 19.1H4.2c-.5 0-.9.4-.9.9s.4.9.9.9h10.9c.5 0 .9-.4.9-.9s-.4-.9-.9-.9zM13.5 22.2H6c-.5 0-.9.4-.9.9s.4.9.9.9h7.5c.5 0 .9-.4.9-.9s-.4-.9-.9-.9zM18.5 12.6h-2.1c0-.1-.1-.2-.2-.3l-5.8-5.8-.1-.1c-.2-.2-.5-.3-.8-.2-.2 0-.3.1-.4.2l-.1.1-5.8 5.8c-.1.1-.2.2-.2.3H.9c-.5 0-.9.4-.9.8 0 .5.4.9.9.9h17.6c.5 0 .9-.4.9-.9 0-.4-.4-.8-.9-.8zm-13.1 0l4.3-4.3 4.3 4.3H5.4zM16.8 16H2.6c-.5 0-.9.4-.9.9s.4.9.9.9h13.9l1-.3c.2-.2.2-.4.2-.6 0-.5-.4-.9-.9-.9zM22 4.9c-2.5-2.8-6.5-3.5-9.7-2l.5-1.9c.1-.4-.2-.9-.6-1-.4-.1-.9.2-1 .6l-.9 3.9s-.2.8.5.9l4 .9h.4c.3-.1.5-.3.6-.6.1-.4-.2-.9-.6-1l-2-.5c2.6-1.2 5.8-.6 7.7 1.6 2.3 2.7 2 6.8-.7 9.1-.4.2-.6.6-.4 1 .1.5.6.7 1.1.6.2 0 .3-.2.5-.3 3.2-2.8 3.6-7.9.6-11.3z" />
          </svg>
          Reorder<span id={styles.newSpan}>NEW</span>
        </a>
        <a id={styles.a}>
          <svg viewBox="0 0 22 16" id={styles.trackOrderSvg}>
        ...
        <a id={styles.a}>
          <svg viewBox="5 2 14 20" id={styles.findStoreSvg}>
        ...
        <div id={styles.dropdownContainer1}>
          <div id={styles.dropdownContainer2}>
            <div id={styles.dropdownContainer3}>
              <svg
                id={styles.flagImg}
                width="18"
                height="12"
              ...
              >
                <g fill="none" fillRule="evenodd">
                  ...
                  <path
                    stroke="#CCC"
                    strokeWidth=".5"
                    d="M.25.25h47.5v31.5H.25z"
                  />
                </g>
              </svg>
              <div id={styles.countryCode}>US</div>
              <span id={styles.arrowSpan} />
            </div>
          </div>
        </div>
      </div>
